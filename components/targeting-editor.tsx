...
export function TargetingEditor({ initial, onSaved }: TargetingEditorProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Discovery rules</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3">
          <p className="text-sm text-muted-foreground">
            Defaults target Applied AI + India/open-remote. Turn on open title
            matching and set home-location regexes for any other sector.
          </p>
          <label className="flex items-center gap-2 text-sm">
            ...
            />
            Open title matching (any title except blocked)
          </label>
          <label className="flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              ...
              className="size-3.5 accent-foreground"
            />
            Soft titles need JD signal patterns
          </label>
          <label className="flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              ...
              className="size-3.5 accent-foreground"
            />
            Keep open-remote / WFH / worldwide roles
          </label>
          <label className="flex items-center gap-2 text-sm">
            <input
              type="checkbox"
              ...
              className="size-3.5 accent-foreground"
            />
            Drop US/UK/EU residency-only postings
          </label>
          ...
          <label className="block space-y-1 text-sm">
            <span className="text-muted-foreground">
              JD signal regexes (one per line)
            </span>
            <textarea
              className="min-h-20 w-full rounded-lg border border-input bg-transparent px-2.5 py-2 font-mono text-xs"
          ...
          <label className="flex items-center gap-2 text-sm">
            <input
              ...
              className="size-3.5 accent-foreground"
            />
            Use only my boards (ignore built-in portal list)
          </label>
        </CardContent>
      </Card>
